            ...
            <div class="col-xl-12 ">
                ...
                <form class="{{ $artist->id }}" method="POST" id="editid" action="{{route('admin.editid')}}" enctype="multipart/form-data" onsubmit="edit()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="alert alert-info" role="alert">   {{$artist->description}}</div>
                    ...
                    <div class="form-group">
                        <input type="checkbox" name="checkbox" id="option" value="{{old('option')}}"><label for="option"><span></span> <p> Выводить на главный экран </p></label>
                    </div>
